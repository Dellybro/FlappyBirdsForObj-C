...
-(UIButton*)defaultButton:(NSString*)text{
    ...
    [defaultB setBackgroundImage:[UIImage imageNamed:@"Start"] forState:UIControlStateNormal];
    [defaultB setBackgroundImage:[UIImage imageNamed:@"Start"] forState:UIControlStateHighlighted];
...
-(UIButton*)defaultMenuButton:(NSString*)title{
    ...
    [button setBackgroundImage:[UIImage imageNamed:@"Start"] forState:UIControlStateSelected];
